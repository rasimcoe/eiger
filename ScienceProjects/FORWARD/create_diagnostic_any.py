...
SAVEFOLDER='/scratch/EIGER/BROAD/VISCHECK/'

#J1120:
CATALOG='/scratch/EIGER/BROAD/J1120_photcat1_BROADsel_16022023.fits'
field='J1120'
RGBFILE='/scratch/EIGER/identification/stiff_bin1_j1120.tif'
...
field='J0148'
RGBFILE='/scratch/EIGER/identification/stiff_bin1_j0148.tif'
directimage='/scratch/EIGER/identification/j0148_F356W.fits' #this is F356W purely SCI extension 
...
#	#2D stacks
	...
	pyplot.savefig(SAVEFOLDER+'spectrum_%s_%s.png'%(field,thisID),dpi=120)
	pyplot.clf()
