...
directimage='/net/selene/scratch/mruari/EIGER/imaging/J1120+0641/F356W/pipe4_filt/stack_F356W_pipe4_v1_20230202.fits'
...
CATALOG='/scratch/EIGER/BROAD/J1120_photcat1_BROADsel_16022023.fits'
...
PRIMDITS=['3','5']  ## <--- VISITGRP=02 or 04
VISITS=[1,2,3,4]
...
def run(qqq):
    ...
    for visitnum in range(len(VISITS)): 
        ...
        if visit ==4:
        	PRIMDITS=['2','4']  ##only for J1120. Thanks STScI
        else:
        	PRIMDITS=['3','5']
...
#                 print('___> ', (RA0,DEC0), ' ==>', (RA,DEC), ' with wcs')
            ...
            for repeat in PRIMDITS:
                ...
                for qj in EXPOSURES:
                    ...
                    reduction_dir = '/net/galaxy-data/export/galaxydata/kashinod/EIGER/J1120/reduction/'
                    scidataname = (reduction_dir+
                                   'calibrated_img2photomskip_wfss_globalskySubtV2_globalMedSubt/'+
                                   'jw0124300400%s_0%s101_00%s_nrc%slong_cal_globalMedSubt.fits'                            
                    ...
                    emdataname = (reduction_dir+
                                  ...
                                  'jw0124300400%s_0%s101_00%s_nrc%slong_cal_globalMedSubt_emline.fits'
                                  %(visit,repeat,qj,module))
                    
                    contdataname = (reduction_dir+
                                   'calibrated_img2photomskip_wfss_globalskySubtV2_globalMedSubt_emlineMaskedV2_contSubt_kx51_9_Skx21_5/'+
                                   'jw0124300400%s_0%s101_00%s_nrc%slong_cal_globalMedSubt_continua.fits'
                                   %(visit,repeat,qj,module))
              
                    ### Spec2 assign_wcs
                    ratename = (reduction_dir+'/calibrated_spc2_bsub/'+
                                'jw0124300400%s_0%s101_00%s_nrc%slong_assign_wcs.fits'%(visit,repeat,qj,module))
                
                    print('___> SCI ')
                    ratename='/scratch/EIGER/reduce_pipeline/reduced/j1120/grism_F356W/jw0124300400%s_0%s101_00%s_nrc%slong_flatfieldstep.fits'%(visit,repeat,qj,module) ##JM. This is only used for WCS, The other assign_wcs doesnt work for my installation. Unclear origin.
