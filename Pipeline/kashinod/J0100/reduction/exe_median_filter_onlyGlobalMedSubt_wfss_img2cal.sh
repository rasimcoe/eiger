...
#nohup python /data/kashinod/JWST/myscripts/median_filter_wfss_img2cal_v20220328.py $fil $output_dir $kx $ky $kx_gap &> $log_dir/$job_name &
nohup python /scratch/kashinod/EIGER/scripts/median_filter_onlyGlobalMedSubt_wfss_img2cal.py $fil $output_dir $kx $ky $kx_gap &> $log_dir/$job_name'.txt' &
