...
inp_fits_files=`ls ./"$input_dir"/jw0124300100[1,2,3,4]_0[2,4]101_000??_nrc[a,b]long_cal_globalMedSubt.fits` ## Don't delete, this is for all grism frames.
...
for fil in $inp_fits_files; do
	...
	exe_subtract_continua_wfss.sh > $log_dir/exe_subtract_continua_wfss_$basename.sh
    
    # Execution
    bash $log_dir/exe_subtract_continua_wfss_$basename.sh
