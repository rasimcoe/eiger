...
cal_fits_files=`ls ./calibrated_img2_wfss/jw01243001001_0[2,4]101_000??_nrc[a,b]long_cal.fits`
...
for fil in $cal_fits_files; do
	...
	exe_median_filter_onlyGlobalMedSubt_wfss_img2cal.sh > exe_median_filter_onlyGlobalMedSubt_wfss_img2cal_$basename.sh
    
    # Execution
    sh exe_median_filter_onlyGlobalMedSubt_wfss_img2cal_$basename.sh
