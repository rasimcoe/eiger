...
- Create lists for globalsky (or master bias) image for each detector
...
- Get globalsky from EMLINE images
...
### Go back to the "raw" cal.fits with the globalsky (master-bias)

- Subtract globalsky from wfss cal.fits files
